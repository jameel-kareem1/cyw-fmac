...
idle:
	...
	cyw_cfg80211_crit_proto_stopped(&btci->vif->wdev, GFP_KERNEL);
 ...
 * @cfg: driver private cyw_cfg80211 data
 *
 * return: 0 on success
 */
int brcmf_btcoex_attach(struct brcmf_cyw_cfg80211_info *cfg)
{
 ...
 * @cfg: driver private cyw_cfg80211 data
 */
void brcmf_btcoex_detach(struct brcmf_cyw_cfg80211_info *cfg)
{
	brcmf_dbg(TRACE, "enter\n");
 ...
 * return: 0 on success
 */
int brcmf_btcoex_set_mode(struct brcmf_cyw_cfg80211_vif *vif,
