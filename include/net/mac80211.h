...
struct ieee80211_chanctx_conf {
	struct cyw_cfg80211_chan_def def;
	struct cyw_cfg80211_chan_def min_def;
 ...
 *	implies disabled. As with the cyw_cfg80211 callback, a change here should
 ...
 *
 * This can be used by mac80211 drivers with direct cyw_cfg80211 APIs
 ...
 * hardware flags.
 *
 * The default mode will be "automatic", which nl80211/cyw_cfg80211
 ...
 *
 * @testmode_cmd: Implement a cyw_cfg80211 test mode command. The passed @vif may
 *	be %NULL. The callback can sleep.
 * @testmode_dump: Implement a cyw_cfg80211 test mode dump. The callback can sleep.
 *
 ...
 * @nan_change_conf: change NAN configuration. The data in cyw_cfg80211_nan_conf
 ...
 *	cyw_cfg80211_nan_func must not be referenced outside the scope of
 *	this call.
...
struct ieee80211_ops {
...
#ifdef CONFIG_PM
	int (*suspend)(struct ieee80211_hw *hw, struct cyw_cfg80211_wowlan *wowlan);
	...
	int (*add_nan_func)(struct ieee80211_hw *hw,
			    struct ieee80211_vif *vif,
			    const struct cyw_cfg80211_nan_func *nan_func);
 ...
 * @gfp: allocation flags
 *
 * See cyw_cfg80211_report_wowlan_wakeup().
 */
 ...
 * @gfp: allocation flags
 *
 * See cyw_cfg80211_tdls_oper_request().
 */
...
void ieee80211_nan_func_match(struct ieee80211_vif *vif,
			      struct cyw_cfg80211_nan_match_params *match,
			      gfp_t gfp);
